...
public static class UpdateChecker
{
	...
	private const string RepoName = "DILApp-Launcher";

	private const string ApiUrl = "https://api.github.com/repos/aaa112222/DILApp-Launcher/releases/latest";
	...
	public static async Task CheckAsync(bool silent = true)
	{
		try
		{
			using HttpResponseMessage resp = await Client.GetAsync("https://api.github.com/repos/aaa112222/DILApp-Launcher/releases/latest");
