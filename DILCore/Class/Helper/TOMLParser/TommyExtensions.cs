...
namespace DILCore.Class.Helper.TOMLParser;
...
public static class TommyExtensions
{
    ...
    extension(TomlNode self)
    {
        ...
        public TomlNode FindNode(string path)
        {
        ...
        public TomlNode MergeWith(TomlNode with, bool mergeNewValues = false)
        {
            switch (self)
            {
